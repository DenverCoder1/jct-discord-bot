...
class ErrorLogger:
    ...
    def log_to_file(self, error: BaseException, message: Optional[nextcord.Message] = None):
    ...
    def __get_err_text(self, error: BaseException, message: Optional[nextcord.Message] = None):
        description = "".join(
    ...
    def read_logs(self, n_lines, char_lim: int = 2000) -> str:
        try:
            ...
            return (
                "https://tenor.com/view/nothing-to-see-here-explosion-explode-bomb-fire-gif-4923610"
            )
